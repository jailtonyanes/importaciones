...
<html>
  <head>
    ...
    <title>Procedimiento:Colonoscopia</title>
                       ...
                       <div class="col-md-3">
                          <div class="box box-primary">
                              ...
                              <div class="box-footer text-center">
                                ...
                                <input id="sel<?php echo $datos[$i]['id'] ?>" value="<?php echo $datos[$i]['id'] ?>" type="checkbox" id="sel<?php echo $datos[$i]['id'] ?>" onclick=" javascript:marcar(this.id)">
                              </div>
                          </div>
                       </div>
                  <?php
                  ...
                  <div class="row"><!-- una fila -->
                             <div class="col-md-6"> 
                              ...
                              <div class="col-md-6"> 
                                  ...
                                  <div class="form-group">
                                     ...
                                     <textarea class="form-control" name="inspeccion" id="inspeccion" placeholder="Escriba sus observaciones" rows="3"></textarea>
                                  </div> 
                             </div>
                         ...
                         <div class="row"><!-- una fila -->
                             <div class="col-md-6"> 
                                  ...
                                  <div class="form-group">
                                     ...
                                     <textarea class="form-control" name="tacto_rectal" id="tacto_rectal"  placeholder="Escriba sus observaciones" rows="3"></textarea>
                                  </div> 
                             </div>
                              <div class="col-md-6"> 
                                  ...
                                  <div class="form-group">
                                     <label>Colon</label>
                                     <textarea class="form-control" name="colon" id="colon" placeholder="Escriba sus observaciones" rows="3"></textarea>
                                  </div> 
                             </div>
                         ...
                         <div class="row"><!-- una fila -->
                             <div class="col-md-6"> 
                                  ...
                                  <div class="form-group">
                                     <label>Ciego</label>
                                     <textarea class="form-control" name="ciego" id="ciego" placeholder="Escriba sus observaciones" rows="3"></textarea>
                                  </div> 
                             </div>
                              <div class="col-md-6"> 
